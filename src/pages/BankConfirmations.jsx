...
const BankConfirmations = () => {
  const records = useQuery(api.bankConfirmations.get) || [];
  const addRecord = useMutation(api.bankConfirmations.add);
  const updateRecord = useMutation(api.bankConfirmations.update);
  const removeRecord = useMutation(api.bankConfirmations.remove);
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      console.error("Failed to save bank confirmation:", err);
