...
const Contact = () => {
  return (
    <div style={{ maxWidth: '600px', margin: '4rem auto', padding: '2.5rem', fontFamily: 'sans-serif', lineHeight: '1.6', color: '#1f2937', background: '#fff', borderRadius: '1rem', boxShadow: '0 4px 24px rgba(0,0,0,0.06)', textAlign: 'center' }}>
      <h1 style={{ fontSize: '2rem', marginBottom: '1.5rem', color: '#111827' }}>Contact</h1>
      <p style={{ marginBottom: '0.5rem', fontSize: '1.05rem', color: '#4b5563' }}>For support or issues, contact:</p>
      <p style={{ marginBottom: '2rem', fontSize: '1.2rem', fontWeight: 600, color: '#2563eb' }}>
        <a href="mailto:admin@kps.com" style={{ textDecoration: 'none', color: 'inherit' }}>admin@kps.com</a>
      </p>
